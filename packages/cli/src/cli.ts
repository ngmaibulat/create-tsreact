...
import { CliError } from "@tsreact/bruno/error";
import { SAMPLE_MODES } from "@tsreact/bruno/spec";
import type { ApiSpec, SampleMode } from "@tsreact/bruno/spec";
...
//
//Declared in @tsreact/bruno because parse/collection/sample all throw it, and
